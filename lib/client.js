	...
	factory: (require) => {
		...
		function apply(ctx) {
			...
			layoutStyleEl.textContent =
				...
				"." + LINE_CLASS + "{" +
				"flex:none;display:flex;align-items:center;white-space:nowrap;overflow:hidden;" +
				"height:calc(26px + var(--dsh-content-font-delta,0px));" +
				"font-size:var(--dsh-content-font-size,14px);" +
				"line-height:calc(22px + var(--dsh-content-font-delta,0px));" +
				"font-weight:600;" +
				"background-image:linear-gradient(90deg,var(--dsw-static-deepseek-500) 0%,var(--dsw-static-deepseek-500) 40%,var(--dsw-static-deepseek-200) 50%,var(--dsw-static-deepseek-500) 60%,var(--dsw-static-deepseek-500) 100%);" +
				"background-size:250% 100%;background-position:100% 0;" +
				"-webkit-background-clip:text;background-clip:text;color:#0000;-webkit-text-fill-color:transparent;" +
